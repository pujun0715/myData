        ...
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            ...
            <el-button @click="tagOrCategory('category', article.category.id)" size="mini" type="primary" round plain>
              {{ article.categoryVo.categoryName }}</el-button>
          </div>
          ...
          <div class="me-view-comment">
            <div class="me-view-comment-write">
              <el-row :gutter="20">
                ...
                <el-col :span="22">
                  <el-input type="textarea" :autosize="{ minRows: 2 }" placeholder="你的评论..." class="me-view-comment-text"
                    v-model="comment.content" resize="none">
                  </el-input>
                </el-col>
              </el-row>
            ...
            <commment-item v-for="(c, index) in comments" :comment="c" :articleId="article.id" :index="index"
              :rootCommentCounts="comments.length" @commentCountsIncrement="commentCountsIncrement" :key="c.id">
            </commment-item>
